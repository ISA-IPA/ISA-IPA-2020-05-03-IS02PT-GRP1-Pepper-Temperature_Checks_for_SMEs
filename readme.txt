...
| :------------ |:---------------:| :-----| :-----|
| CAO LIANG            | A0012884E | Email module, python code for thermometer reading using Google Cloud Vision API, parts of reports on system architecture diagram, help with integration with other team members on Email module and temperature reading functions 		   | e0384184@u.nus.edu |
...
| HAN DONGCHOU FRANCIS | A0195414A | Leading and formalizing the project requirements, first level of integration of the different components of the system SIT testing, reviews with each team member, script for the video.                            | e0385045@u.nus.edu |
| ONG BOON PING        | A0195172B | UIPath, face recognition program, Integration of the face recognition and Text Recognition with UIPath                                | e0384803@u.nus.edu |
